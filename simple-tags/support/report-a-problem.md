...
If you encounter an issue while using **SimpleTags**, please report it through our Jira support process.
...
1. Navigate to **Account Record Page**
2. Open the **SimpleTags component**
3. Search for a tag called **"Education"**
4. Attempt to add the tag
...
> The tag should have been added successfully and displayed in the tag list.
...
> The component displayed an error message and the tag was not added.
...
- [How SimpleTags Works](/architecture/how-simpletags-works)
