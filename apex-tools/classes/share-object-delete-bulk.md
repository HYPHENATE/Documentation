...
Bulk version of ShareObjectDelete to be called on multiple records
...
|------|------|
| Primary purpose | Bulk version of ShareObjectDelete to be called on multiple records |
...
| `getIdsForQuery` | Returns or loads data used by the class. |
...
| Package Role | `ShareObjectDeleteBulk` is part of the ApexTools reusable framework and should be understood in the context of the wider package design. |
