...
|------|------|
| Primary purpose | Functions on Lists |
...
| Method | Purpose |
|------|------|
| `sort` | Supports internal or reusable behaviour within the class. |
| `quickSort` | Supports internal or reusable behaviour within the class. |
| `quickSort` | Supports internal or reusable behaviour within the class. |
| `partition` | Supports internal or reusable behaviour within the class. |
...
| Package Role | `Lists` is part of the ApexTools reusable framework and should be understood in the context of the wider package design. |
