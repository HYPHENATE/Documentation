# CustomSharingDeleteHandlerBatch
...
Batchable version of CustomShareDelete code
...
|------|------|
| Primary purpose | Batchable version of CustomShareDelete code |
...
| Package Role | `CustomSharingDeleteHandlerBatch` is part of the ApexTools reusable framework and should be understood in the context of the wider package design. |
