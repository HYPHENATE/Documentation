...
Class to hold invocable method for creating shares
...
|------|------|
| Primary purpose | Class to hold invocable method for creating shares |
...
|------|------|------|
| `runMetaShareHandler` | `List<MetaSharingOutput>` | Exposes package functionality to Flow or invocable automation. |
...
| Package Role | `MetaSharingCreateShares` is part of the ApexTools reusable framework and should be understood in the context of the wider package design. |
