...
|------|------|
| Primary purpose | SObject field getter class |
...
| Method | Purpose |
|------|------|
| `get` | Returns or loads data used by the class. |
...
| Package Role | `SObjectGetter` is part of the ApexTools reusable framework and should be understood in the context of the wider package design. |
