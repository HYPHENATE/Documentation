...
|------|------|
| Primary purpose | Return string in lowerCase format |
...
| Method | Purpose |
|------|------|
| `call` | Supports internal or reusable behaviour within the class. |
...
| Package Role | `StringLowerCaseFunction` is part of the ApexTools reusable framework and should be understood in the context of the wider package design. |
