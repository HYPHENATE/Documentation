...
Invocable Variables for use in MetaSharingHelper.runMetaShareHandler
...
|------|------|
| Primary purpose | Invocable Variables for use in MetaSharingHelper.runMetaShareHandler |
...
| Package Role | `MetaSharingDeleteConfig` is part of the ApexTools reusable framework and should be understood in the context of the wider package design. |
