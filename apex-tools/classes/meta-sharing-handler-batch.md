...
Batch Sharing Handler class to handle large record numbers
...
|------|------|
| Primary purpose | Batch Sharing Handler class to handle large record numbers |
| Sharing support | Supports dynamic sharing, share record creation, deletion, or related configuration handling. |
| Callable methods | Exposes 7 callable method(s) for package or implementation use. |
...
| `logErrors` | Supports internal or reusable behaviour within the class. |
...
| Package Role | `MetaSharingHandlerBatch` is part of the ApexTools reusable framework and should be understood in the context of the wider package design. |
